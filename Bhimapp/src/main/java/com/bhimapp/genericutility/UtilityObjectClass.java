...
public class UtilityObjectClass {
	...
	private static ThreadLocal<PropertyFile> fileUtility = new ThreadLocal<PropertyFile>();
	 ...
	 * @return
	 */
	public static PropertyFile  getFileUtility() {
	 ...
	 */
	public static void setFileUtility(PropertyFile actFileUtility) {
